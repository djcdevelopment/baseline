...
- PASS `gateway_websocket_fallback_delivery` — received=9; relayed=9; expected_relayed=9
...
- `pressure_to_transport`: 9 selected presentation decisions reached the real WebSocket fallback seam; 23 deferred/dropped decisions did not
