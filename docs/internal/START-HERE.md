...
| AM4 Valheim capture host (`homebase`, native Linux client on the RTX 5070) | **LIVE** | Era photography and 4K capture. Its BepInEx plugin set is the capture mod plus the third-party **ComfyMods BetterServerPortals 1.7.0** (Thunderstore package, upstream `github.com/redseiko/ComfyMods`), SHA-256 `1bc8b1369899d8dee290806c4920b0f7051c8087a2c7d391070aaf1a9b592399`, deployed at `/home/derek/valheim/BepInEx/plugins/BetterServerPortals.dll` per `fieldlab/runs/build-requests/br-20260909-033145-30562f3d.receipt.json`. The staging copy sits at `tools/BetterPortals/` in this checkout and is gitignored; it is not Baseline code. |
