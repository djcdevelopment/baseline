...
Issue reports, reproducible test results, documentation corrections, and
design discussion are welcome. Do not include credentials, personal data,
private server details, proprietary game files, decompiled assemblies, or
...
Every contributor must be able to confirm that:

- the contribution is their original work or is accompanied by permission
  sufficient for the project to use and relicense it;
- their employer, client, school, or other organization does not own or
  restrict the contribution;
- third-party material and applicable licenses are identified;
- appreciable AI-generated material is disclosed to the maintainer; and
- the contribution contains no secrets, personal data, private diagnostic
  URLs, or unauthorized proprietary material.

The maintainer may require provenance records, a signed contributor
agreement, or removal of material that cannot be confidently licensed.
