...
|---|---|---|---|
| `ComfyCameraProof.dll` | 0.2.3 (feed mode, 1.0 cloth skip, intro skip) | MIT | `github.com/djcdevelopment/comfy`, `handoffs/valheim-camera-proof/Plugin.cs`, commit `44ba27f`; built with `dotnet build -c Release` against the Valheim 1.0 client (build 25185596) and BepInEx 5.4.23.3 |
