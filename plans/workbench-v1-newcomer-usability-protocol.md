...
6. On the narrow/mobile view, return to Home, Explore, Jobs, and Recover without
   horizontal scrolling or hidden controls.

## Pass criteria

All six tasks complete without shell access, repository knowledge, or facilitator
